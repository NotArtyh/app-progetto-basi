...
public class UsersInventoryPanel extends JPanel {
    ...
    private void loadAllUsersWithInventories() {
        ...
        try {
            ...
            /*
            this.allUsers = userDAO.getAllUsersExceptCurrent(Sessionmanager.getInstance().getCurrentUser().getUserId()))
            * Questo metodo recupera tutti gli utenti dal database, escludendo l'utente corrente.
